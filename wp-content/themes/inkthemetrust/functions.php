...
function ttrust_scripts() {	
	...
	wp_enqueue_script('jquery_ui', get_bloginfo('template_url').'/js/jquery-ui-1.10.0.custom.min.js', array('jquery'), '1.10.0', true);
	
	wp_enqueue_style('jquery_ui_style', get_bloginfo('template_url').'/css/jquery-ui.css', false, '1.10.0', 'all' );
	...
	wp_enqueue_style('fontawesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css', false, '1.4.8', 'all' );
	

	wp_enqueue_script('select_2', get_bloginfo('template_url').'/js/plugins/select2-3.5.4/select2.min.js', array('jquery'), '3.4.5', true);
	wp_enqueue_style('select_2_style', get_bloginfo('template_url').'/js/plugins/select2-3.5.4/select2.css', false, '3.4.5', 'all');
	

	//wp_enqueue_script('dragend', get_bloginfo('template_url').'/js/dragend.min.js', array('jquery'), '1.0', true);
	//wp_enqueue_script('touch_swipe', get_bloginfo('template_url').'/js/jquery.touchSwipe.min.js', array('jquery'), '1.6', true);
...
#content .project.small .overlay, .f_circleG, .skillList li span a:hover, .tax-skill #pageHead { background: <?php echo(of_get_option('ttrust_color_accent')); ?>;}
...
set_post_thumbnail_size(600, 348, true);
add_image_size('ttrust_post_thumb_big', 600, 348, true);
...
function newgravatar ($avatar_defaults) {
	...
	$avatar_defaults[$myavatar] = "Default User Image";
...
function trim_indices(&$item1, $key) {
